				...
				<div className="col-1-of-3">
					<div className="feature-box">
						...
						<div className="feautre-box__education-content">
							...
							<p className="feature-box__text">
								Completed Bachelors in <strong>Computer Science </strong> from Vignan Insitute of Science of Technology
								during <strong>2008-2012.</strong>
							</p>
						</div>
					</div>
				</div>
				...
				<div className="col-1-of-3">
					<div className="feature-box">
						...
						<ul className="feature-box__hobbies">
							<li><span> Travelling</span> <br /></li>
							<li><span> Cooking</span><br /></li>
							<li><span> Listening Podcast</span></li>
							<li><span> Philosophy</span></li>
							<li><span> Netflix & Chill</span></li>
						</ul>
					</div>
				</div>
			</div>
