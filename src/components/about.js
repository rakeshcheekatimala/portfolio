  ...
  return (
    <section className="section-about" id="about-me">
      <div className="u-center-text u-margin-bottom-big">
        <h2 className="heading-secondary">Build What Customers Love</h2>
      </div>
      ...
      <div className="row">
        <div className="col-1-of-2">
          {about_sections.map(section => {
            return (
              <div key={section.name} className="section-about__list">
          ...
          <a href="#technical-skills" className="btn-text">
            Read more &rarr;
          </a>
        </div>
        <div className="col-1-of-2">
